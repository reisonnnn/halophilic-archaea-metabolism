...
kegg <- read_csv("HA_GhostKOALA.csv", col_names = FALSE)
...
pathway_descriptions <- read.table("hab.txt", sep = "\t", header = FALSE, col.names = c("Pathway", "Description"))
...
write.csv(annotated_genes_new, file = "HA_annotated_pathway_genes.csv", row.names = FALSE)
