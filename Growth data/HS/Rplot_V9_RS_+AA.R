...
table_grob <- tableGrob(
  data.frame(
    Component = c("Basic salts", "Phosphate", "Trace elements",
                  "Vitamins", "Amino acids", "Glucose", "Glycerol"),
    `RS +AA` = c("+", "+", "+", "+", "+", "-", "-"),
    `RS +AA +Glucose` = c("+", "+", "+", "+", "+", "+", "-"),
    `RS +AA +Glycerol` = c("+", "+", "+", "+", "+", "-", "+"),
    `RS +AA +Glucose +Glycerol` = c("+", "+", "+", "+", "+", "+", "+"),
    check.names = FALSE
  ),
  rows = NULL,
...
# Save all plots
ggsave(file.path(output_dir, "p_all.png"), p_all,
       width = 2200, height = 1800, dpi = 300, units = "px")
ggsave(file.path(output_dir, "p_qq.png"), p_qq,
       width = 1600, height = 1600, dpi = 300, units = "px")
ggsave(file.path(output_dir, "p_72h_bar_pvalue.png"), p_bar,
       width = 2400, height = 1800, dpi = 300, units = "px")
ggsave(file.path(output_dir, "p_72h_bar_asterisk_with_table.png"), combined_plot,
       width = 2400, height = 2400, dpi = 300, units = "px")
