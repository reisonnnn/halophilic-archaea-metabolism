# ==============================================================================
# METABOLIC PATHWAY MAP & HEATMAP VISUALIZATION
# ==============================================================================
...
# Focus on major metabolic pathways - FIXED COUNT (59 pathways)
major_pathways <- c(
...
pathway_names_full <- data.frame(
  ...
  pathway_name = c(
    ...
    "Vitamin B6", "Pantothenate/CoA", "Biotin", "Lipoic acid", "Porphyrin/chlorophyll",
    "Ubiquinone/terpenoid", "Nicotinate/nicotinamide", "Nitrogen", "Sulfur"
  ),
  stringsAsFactors = FALSE
)
