...
table_grob <- tableGrob(
  data.frame(
    Component = c("H", "M", "S", "K", "I", "Y", "F", "V", "P", "L", "W", "T", "G", "Q", "E", "C", "D", "N", "R", "A"),
    `RS +20AA` = c("+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+"),
    `RS +11AA` = c("+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "-", "+", "-", "-", "-", "-", "-", "-", "-", "-"),
    `RS +11AA +R +C +W` = c("+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "-", "-", "-", "+", "-", "-", "-", "+"),
    `RS +11AA +R +C` = c("+", "+", "+", "+", "+", "+", "+", "+", "+", "+", "-", "+", "-", "-", "-", "+", "-", "-", "-", "+"),
...
ggsave(file.path(output_dir, "p_72h_bar_asterisk.tiff"), p_bar_ast,
       width = 2400, height = 1800, dpi = 300, units = "px")

# Save table separately as TIFF
ggsave(file.path(output_dir, "media_composition_table.tiff"), table_grob,
       width = 3600, height = 3600, dpi = 300, units = "px")
