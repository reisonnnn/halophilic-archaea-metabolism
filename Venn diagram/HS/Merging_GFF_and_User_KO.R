...
kegg <- read_csv("HS_GhostKOALA.csv", col_names = FALSE)
...
pathway_descriptions <- read.table("hags.txt", sep = "\t", header = FALSE, col.names = c("Pathway", "Description"))
...
write.csv(annotated_genes_new, file = "HS_annotated_pathway_genes.csv", row.names = FALSE)
